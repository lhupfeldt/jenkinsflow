...
def test_invoke_unchecked():
    with mock_api.api(__file__) as api:
        ...
        api.job('j6', exec_time=0.01, max_fails=0, expect_invocations=1, expect_order=4)
        api.job('j7', exec_time=0.01, max_fails=0, expect_invocations=1, expect_order=5)
